...
public class StudentLoginForm extends javax.swing.JFrame {
    ...
    ResultSet rs;
     private void scaleImage(){
        ImageIcon icon=new ImageIcon("D:\\nibm project\\LearningManagementSystem\\src\\main\\java\\com\\mycompany\\learningmanagementsystem\\Images\\Students-rafiki.png");
    ...
    private void login_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_login_btnActionPerformed
        ...
        try {
            ...
            pst = connection.prepareStatement("SELECT * FROM student WHERE userName = ? AND password = ?");
